"""
Django settings for math_workbook_44676 project.
...
ROOT_URLCONF = 'math_workbook_44676.urls'
...
WSGI_APPLICATION = 'math_workbook_44676.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "math_workbook_44676 API",
    "DESCRIPTION": "API documentation for math_workbook_44676 App",
    "VERSION": "v1",
}
